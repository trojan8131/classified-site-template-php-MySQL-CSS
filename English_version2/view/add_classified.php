<section id="add_classified">
    ...
    <?php if ($_SESSION['user']['userid'] != "Guest") { ?>
        <form action="<?= $this->baseurl ?>" id="add_form" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="cla_title" required placeholder="Classified title"><br />
            <input type="text" name="cla_summary" required placeholder="Tags"><br />
            <textarea name="cla_text" cols="80" rows="10" required placeholder="Classified text"></textarea><br />
            <script>
                var countries = [<?php
            ...
            <input type='tel' name="cla_tel" value="" placeholder="Phone number" pattern="[0-9]{9}" required \>
