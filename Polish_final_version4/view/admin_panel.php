...
<section id="search">
<a class="button-79" href="?cmd=categories">Kategorie</a>
<a class="button-79" href="?cmd=events">Wydarzenia</a>
<a class="button-79" href="?cmd=userlist">Uzytkownicy</a>
<?php if(isset($_SESSION['userlist']) and $_SESSION['userlist']){ ?>
<br />
<table><tr><th>Userid</th><th>username</th><th>userlevel</th><th>useremail</th><th>userlevel</th><th></th></th></tr>
...
<td><?=$v['useremail']?></td>
<td><?=$v['userlevel']?></td>
<?php if($v['userid']!='admin'){ ?>
    <td>
<a  class="button-79" style="background:green;width:100%;" href="?cmd=changeuser&userid=<?=$v['userid']?>">Change level</a>&nbsp;
<a  class="button-79" style="background:red;width:100%;" href="?cmd=deluser&userid=<?=$v['userid']?>">Delete user</a>
<?php } ?></td>
</tr>
<?php } ?>
</table>
